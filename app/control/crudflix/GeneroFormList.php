...
class GeneroFormList extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Gênero de Filmes');
        ...
        $this->form->addFields( [ new TLabel('Genero') ], [ $generoDescricao ] );



        // set sizes
        $id->setSize('10%');
        $generoDescricao->setSize('80%');
        ...
        $column_generoDescricao = new TDataGridColumn('generoDescricao', 'Genero', 'left');
