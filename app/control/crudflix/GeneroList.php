...
class GeneroList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Genero');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['GeneroForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['GeneroForm', 'onEdit'], ['id'=>'{id}']);
