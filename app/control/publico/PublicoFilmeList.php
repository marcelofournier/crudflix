...
class PublicoFilmeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('CrudFlix - Filmes cadastrados');
        ...
        $this->form->addFields( [ new TLabel('Avaliação') ], [ $avaliacao ] );
    ...
    public function onSearch()
    {
        ...
        TSession::setValue(__CLASS__.'_filter_pais_id',   NULL);
        ...
        if (isset($data->pais_id) AND ($data->pais_id)) {
            $filter = new TFilter('pais_id', '=', $data->pais_id); // create the filter
            TSession::setValue(__CLASS__.'_filter_pais_id',   $filter); // stores the filter in the session
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue(__CLASS__.'_filter_pais_id')) {
                $criteria->add(TSession::getValue(__CLASS__.'_filter_pais_id')); // add the session filter
            }
